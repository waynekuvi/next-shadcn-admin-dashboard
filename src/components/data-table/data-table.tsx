...
function renderTableBody<TData, TValue>({
  ...
  // console.log("DataTable Body - Rows:", rows.length, "DataIds:", dataIds.length);
...
export function DataTable<TData, TValue>({
  ...
  const dataIds: UniqueIdentifier[] = table.getRowModel().rows.map((row) => row.id);
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    if (active && over && active.id !== over.id && onReorder) {
      ...
      // Note: table.options.data gives us the data array
