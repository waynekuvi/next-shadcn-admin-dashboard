...
function ChipSVG() {
  return (
    <svg enableBackground="new 0 0 132 92" viewBox="0 0 132 92" xmlns="http://www.w3./2000/svg" className="w-14">
      <title>Chip</title>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium tabular-nums">{formatCurrency(62000, { fromCurrency: "USD" })}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-muted-foreground">Available Balance</span>
                  <span className="font-medium tabular-nums">{formatCurrency(13100.06, { fromCurrency: "USD" })}</span>
                </div>
              </div>
                    ...
                    <div key={transaction.id} className="flex items-center gap-2">
                      ...
                      <div className="flex w-full items-end justify-between">
                        ...
                        <div>
                          ...
                          >
                            {formatCurrency(transaction.amount, { fromCurrency: "USD", noDecimals: true })}
                          </span>
                        </div>
                      </div>
                    </div>
