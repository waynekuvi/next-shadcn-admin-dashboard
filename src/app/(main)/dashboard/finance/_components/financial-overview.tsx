        ...
        <div className="flex flex-col items-start justify-between gap-2 py-5 md:flex-row md:items-stretch md:gap-0">
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium tabular-nums">{formatCurrency(totalIncome, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
          ...
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium tabular-nums">{formatCurrency(totalExpenses, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
          <Separator orientation="vertical" className="!h-auto" />
          <div className="flex flex-1 items-center justify-center gap-2">
            ...
            <div>
              ...
              <p className="font-medium tabular-nums">{formatCurrency(totalScheduled, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
        </div>
        <Separator />
