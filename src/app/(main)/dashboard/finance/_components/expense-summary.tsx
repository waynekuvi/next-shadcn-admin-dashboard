                    ...
                    if (viewBox && "cx" in viewBox && "cy" in viewBox) {
                      return (
                        <text x={viewBox.cx} y={viewBox.cy} textAnchor="middle">
                          ...
                          >
                            {formatCurrency(totalExpenses, { fromCurrency: "USD", noDecimals: true })}
                          </tspan>
        ...
        <div className="flex justify-between gap-4">
          <div className="flex flex-1 flex-col items-center space-y-2">
            ...
            <div className="space-y-0.5 text-center">
              ...
              <p className="font-medium tabular-nums">{formatCurrency(chartData[0].groceries, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col items-center space-y-2">
            ...
            <div className="space-y-0.5 text-center">
              ...
              <p className="font-medium tabular-nums">{formatCurrency(chartData[0].transport, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
          <Separator orientation="vertical" className="!h-auto" />
          <div className="flex flex-1 flex-col items-center space-y-2">
            ...
            <div className="space-y-0.5 text-center">
              ...
              <p className="font-medium tabular-nums">{formatCurrency(chartData[0].other, { fromCurrency: "USD", noDecimals: true })}</p>
            </div>
          </div>
        </div>
        <span className="text-muted-foreground text-xs tabular-nums">
          Weekly spending is capped at {formatCurrency(2000, { fromCurrency: "USD", noDecimals: true })}
        </span>
      </CardContent>
    </Card>
  );
